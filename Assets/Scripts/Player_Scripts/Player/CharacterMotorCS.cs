...
public class CharacterMotorCS : MonoBehaviour 
{
	...
	void Awake () 
	{
		...
		/* <<<<< */
		// TODO: disable collisions between player collider objects
		//controller.detectCollisions = false;
		//Collider[] cols = GameObject.FindGameObjectsWithTag(")
		//Physics.IgnoreCollision(CharacterController, CharacterController);
		/* >>>>> */
		tr = transform;
	}
	...
	void OnControllerColliderHit ( ControllerColliderHit hit )
	{
		...
		if (!hit.gameObject.CompareTag ("TestObject")) {
			return;
		}
		Debug.Log ("derp");
